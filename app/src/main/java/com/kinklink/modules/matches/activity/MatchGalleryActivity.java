...
public class MatchGalleryActivity extends AppCompatActivity implements View.OnClickListener, ViewPager.OnPageChangeListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        progress = new Progress(MatchGalleryActivity.this);
        imagesList = new ArrayList<>();
        GetUserDetailModel getUserDetailModel = (GetUserDetailModel) getIntent().getSerializableExtra("getUserDetail");
        ...
        setUserData(getUserDetailModel);
    ...
    // Getting User Images and adding in list to display
    private void setUserData(GetUserDetailModel getUser) {
