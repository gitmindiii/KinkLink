...
public class MyOfferListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MyOfferListAdapter(Context mContext, ArrayList<OfferListModel.OfferListBean> offerList, AdapterViewPositionListener listener) {
        ...
        if (h instanceof SimpleViewHolder) {
            ...
            switch (offerModel.offer_status) {
                case "0":
                    ...
                    holder.tv_pending_status.setText(mContext.getResources().getString(R.string.request_pending));
                    holder.tv_pending_status.setTextColor(ContextCompat.getColor(mContext,R.color.pending_text_color));
                    holder.tv_pending_status.setVisibility(View.VISIBLE);
            ...
            holder.rl_message_view.setVisibility(View.VISIBLE);
    ...
    public class SimpleViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        TextView tv_offer_price, tv_you_pay_price, tv_counter_price, tv_offer_name, tv_offer_age, tv_offer_gender, tv_offer_time, tv_offer_city,
                btn_accept_offer, btn_counter_offer, btn_decline_offer, tv_payment_type, tv_offer_status, tv_pending_status;
        ...
        SimpleViewHolder(View itemView) {
            ...
            tv_pending_status = itemView.findViewById(R.id.tv_pending_status);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        LinearLayout ly_offer_price, ly_you_pay, ly_counter_price, ly_payment_amount, ly_accept_reject;
        TextView tv_offer_price, tv_you_pay_price, tv_counter_price, tv_offer_name, tv_offer_age, tv_offer_gender, tv_offer_time, tv_offer_city,
                btn_accept_offer, btn_counter_offer, btn_decline_offer, tv_payment_type, tv_offer_message, tv_offer_status, tv_pending_status;
