...
public class FilterInterestsAdapter extends BaseAdapter {
    ...
    public FilterInterestsAdapter(String selected_interests, Context mContext, ArrayList<InterestsModel> interestsList, InterestIdListener interestIdListener) {
        this.mContext = mContext;
        this.interestsList = interestsList;
        this.listener = interestIdListener;
        this.selectItem = selected_interests;
    }
